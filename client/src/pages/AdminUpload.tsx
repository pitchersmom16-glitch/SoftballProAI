          ...
          <Card className="p-6 bg-slate-800 border-slate-700">
            ...
            <ul className="text-sm text-slate-300 space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <code className="text-[#FF10F0]">name</code> - Drill name
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#39FF14]">*</span>
                <span>
                  <code className="text-[#FF10F0]">description</code> - What the drill does
                </span>
              </li>
            </ul>
            ...
            <ul className="text-sm text-slate-300 space-y-1">
              <li>
                <code className="text-slate-400">difficulty</code> - Beginner/Intermediate/Advanced
              </li>
              <li>
                <code className="text-slate-400">videoUrl</code> - YouTube link
              </li>
              <li>
                <code className="text-slate-400">expertSource</code> - Coach name
              </li>
              <li>
                <code className="text-slate-400">mechanicTags</code> - Array of tags
              </li>
              <li>
                <code className="text-slate-400">issueAddressed</code> - Problem it fixes
              </li>
              <li>
                <code className="text-slate-400">equipment</code> - Array of items
              </li>
              <li>
                <code className="text-slate-400">ageRange</code> - e.g., "8U-12U"
              </li>
            </ul>
          </Card>
          ...
          <Card className="p-6 bg-slate-800 border-slate-700">
            ...
            <ul className="text-sm text-slate-400 space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span>
                  You can paste a raw array <code>[...]</code> or an object with a{' '}
                  <code>drills</code> property
                </span>
              </li>
              <li className="flex items-start gap-2">
