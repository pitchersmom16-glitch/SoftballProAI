...
export default function PublicProfile() {
  ...
  const demoGoals: SeasonGoal[] = [
    ...
    },
    {
      ...
      target: 200,
      unit: 'rpm',
      currentBaseline: 1800,
      progress: 45,
    },
    {
      metric: 'strike_zone',
      metricLabel: 'Strike Zone %',
      target: 70,
      unit: '%',
      currentBaseline: 62,
      progress: 75,
    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-purple-950/20">
      <div className="max-w-5xl mx-auto p-6 space-y-8">
        ...
        >
          ...
          <div className="relative flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-left space-y-3">
              <h1 className="text-4xl font-bold text-foreground" data-testid="text-athlete-name">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">On-field performance metrics</p>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-3">
                {displayStats.era && (
                  <div
                    className="p-4 rounded-lg bg-background/50 border border-pink-500/20 text-center"
                    data-testid="stat-era"
                  >
                ...
                {displayStats.avg && (
                  <div
                    className="p-4 rounded-lg bg-background/50 border border-purple-500/20 text-center"
                ...
                {displayStats.exitVelocity && (
                  <div
                    className="col-span-2 p-4 rounded-lg bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 text-center"
                    data-testid="stat-exit-velo"
                  >
                    <p className="text-3xl font-bold text-foreground">
                      {displayStats.exitVelocity}{' '}
          ...
          <CardContent className="space-y-6">
            {displayGoals.map((goal, index) => (
              <div key={index} className="space-y-2" data-testid={`goal-${index}`}>
                ...
                <div className="flex items-center gap-3">
                  <Progress value={goal.progress || 0} className="h-3 flex-1 bg-background/50" />
        ...
        <div className="text-center py-6">
          <p className="text-sm text-muted-foreground">
            Powered by <span className="text-purple-400 font-semibold">SoftballProAI</span>{' '}
