...
export default function SpecialistRoster() {
  ...
  const approveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description:
          'Student dashboard has been unlocked. They can now access their training plan.',
      });
    },
    onError: (error: any) => {
      toast({
  ...
  const getStatusBadge = (student: Student) => {
    if (student.needsReview) {
      return (
        <Badge variant="destructive" data-testid={`badge-status-${student.id}`}>
    ...
    if (!student.baselineComplete) {
      return (
        <Badge variant="secondary" data-testid={`badge-status-${student.id}`}>
          <Clock className="w-3 h-3 mr-1" />
          Onboarding ({student.baselineVideoCount}/4)
        </Badge>
      );
    }
    if (student.dashboardUnlocked) {
      return (
        <Badge variant="default" data-testid={`badge-status-${student.id}`}>
    ...
    return (
      <Badge variant="outline" data-testid={`badge-status-${student.id}`}>
        Pending
      </Badge>
    );
  };
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Dialog open={showInviteDialog} onOpenChange={setShowInviteDialog}>
              ...
              <DialogContent
                className="bg-[#0a0a0a] border-purple-500/30"
                data-testid="dialog-invite"
              >
                <DialogHeader>
                  <DialogTitle className="text-white">Invite New Student</DialogTitle>
                  <DialogDescription className="text-gray-400">
                    Send an invite to a student or their parent. They will receive a unique link to
                    register.
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4 mt-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setInviteData({ ...inviteData, parentEmail: e.target.value })
                      }
                      className="bg-black/50 border-gray-700"
                  ...
                  <Button
                    ...
                    disabled={
                      ...
                      (!inviteData.parentEmail && !inviteData.studentEmail && !inviteData.phone)
                    }
          ...
          <Card className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 border-purple-500/30 p-4 mb-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                ...
                <p className="text-lg font-mono text-purple-400" data-testid="text-referral-code">
        ...
        {spotsRemaining <= 5 && spotsRemaining > 0 && (
          <div
            ...
            data-testid="alert-spots-remaining"
          >
        ...
        <Dialog open={showReviewDialog} onOpenChange={setShowReviewDialog}>
          <DialogContent
            className="bg-[#0a0a0a] border-purple-500/30 max-w-4xl max-h-[90vh] overflow-y-auto"
          ...
          >
            <DialogHeader>
              ...
              <DialogDescription className="text-gray-400">
                Review the student's baseline videos and AI analysis, then create their training
                roadmap.
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="space-y-6 mt-4">
                <div className="grid grid-cols-2 gap-4">
                  {VIDEO_LABELS.map((label, idx) => {
                    const video = selectedStudent.baselineVideos?.find(
                      (v) => v.videoNumber === idx + 1,
                    );
                    return (
                ...
                <div className="flex gap-2">
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        queryClient.invalidateQueries({
                          queryKey: ['/api/specialist/baseline-queue'],
                        });
                      } catch (error) {
                        toast({
                  ...
                  <Button
                    onClick={() =>
                      selectedStudent && approveMutation.mutate(selectedStudent.playerId)
                    }
