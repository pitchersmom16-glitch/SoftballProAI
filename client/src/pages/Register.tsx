...
export default function Register() {
  ...
  const [registrationStep, setRegistrationStep] = useState<
    'validating' | 'ready' | 'completing' | 'done' | 'error'
  >('validating');
  ...
  if (registrationStep === 'validating' || isLoading) {
    return (
      <div
        ...
        data-testid="loading-validation"
      >
    ...
    return (
      <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4">
        <Card className="max-w-md w-full p-8 bg-[#0a0a0a] border-green-500/30 text-center">
          ...
          <p className="text-purple-400">Redirecting to your onboarding checklist...</p>
        </Card>
      </div>
    );
  }
  ...
  if (registrationStep === 'completing') {
    return (
      <div
        className="min-h-screen bg-[#050505] flex items-center justify-center"
        data-testid="completing-registration"
      >
        <div className="text-center">
          <Loader2 className="w-12 h-12 animate-spin text-purple-500 mx-auto mb-4" />
      ...
      <Card className="max-w-lg w-full p-8 bg-[#0a0a0a] border-purple-500/30">
        ...
        <div className="space-y-4 mb-8">
          <div className="flex items-center gap-3 text-gray-300">
            ...
            <span>
              {isTeamReferral
                ? 'Join your team roster instantly'
                : 'Personalized training program designed for you'}
            </span>
          </div>
          <div className="flex items-center gap-3 text-gray-300">
            <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" />
          ...
          <div className="flex items-center gap-3 text-gray-300">
            ...
            <span>
              {isTeamReferral
                ? 'Access team drills and training plans'
