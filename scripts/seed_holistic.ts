...
const HITTING_DRILLS = [
  {
    ...
    difficulty: 'Beginner',
    description:
      'Place tee at front of plate. Focus on driving through the ball with full extension. Finish with hands high and bat pointing to opposite field. Teaches proper extension and prevents cutting swings short.',
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      'Partner tosses balls to inside and outside zones. Hitter must adjust contact point - pull inside pitches, drive outside pitches to opposite field. Develops plate coverage and pitch recognition.',
  ...
  },
  {
    ...
    description:
      'Focus on creating separation between lower and upper body during load. Stride foot lands while hands stay back. Creates torque and stored energy for explosive swing. Key to power generation.',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    description:
      'Stand with bat behind back, hands on hips. Practice explosive hip rotation leading the swing. Back hip drives through to pitcher. Teaches that power comes from ground up, not arms.',
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      'Place cone behind back foot. Hit off tee without knocking cone over. Forces weight to stay back during load and shift forward only at contact. Fixes lunging and reaching.',
...
const CATCHING_DRILLS = [
  {
    ...
    difficulty: 'Intermediate',
    description:
      "Partner throws pitches just below the zone. Catch with soft hands and 'stick' the ball at bottom of zone. Glove moves slightly up on catch, never down. Quiet body, let glove do the work.",
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      'Drop to knees, tuck chin, glove fills hole between legs. Shoulders rounded forward to create wall. Practice with tennis balls first, then softballs. Goal: keep ball in front, smother it.',
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    description:
      'From receiving stance, practice explosive jab step with right foot while ball is in flight. Right foot replaces left, body squares to second base. Exchange happens during footwork, not after.',
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      'Partner throws from 20 feet. Focus on catching the ball silently - no pop in glove. Let ball travel deep into glove pocket. Soft hands absorb impact. Develops touch for framing.',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    description:
      "Practice glove-to-hand transfer without throwing. Catch, transfer to throwing hand at ear, back to glove. Repeat 20 times. Goal: sub-0.3 second transfer. Bare hand meets ball, doesn't chase it.",
