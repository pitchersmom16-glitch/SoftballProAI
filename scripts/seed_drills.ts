...
const PITCHING_DRILLS: DrillSeed[] = [
  {
    ...
    description:
      "The shoulder's internal rotation is THE source of velocity. Start with arm at 90 degrees, elbow at shoulder height. Rotate forearm forward explosively while keeping elbow stationary. This isolates the internal rotators that generate 40-60% of pitch velocity.",
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    description:
      'The windmill delivery creates power through hip-shoulder separation. Hips must fire first, creating 40-50 degrees of separation between pelvis and trunk. This stretch-shortening cycle loads the core like a rubber band.',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    description:
      "The drag foot isn't passive - it's an active stabilizer. The posterior chain maintains ground contact while the hip drives forward. Feel the drag foot pulling through the dirt, not lifting.",
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    description:
      'True rise ball requires 1400+ RPM backspin with 12-6 axis. The Magnus effect creates upward force opposing gravity. Focus on aggressive wrist supination through release.',
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    description:
      'The drop ball uses topspin creating downward Magnus force. At release, fingers pull DOWN and THROUGH the ball, staying on top. 1200+ RPM creates sharp late break.',
...
const CATCHING_DRILLS: DrillSeed[] = [
  {
    ...
    difficulty: 'Intermediate',
    description:
      'Elite framers receive the ball with soft, quiet hands that absorb impact and subtly guide the ball into the zone. Practice catching with minimal glove movement - stick the pitch where you receive it.',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    description:
      'Blocking is about getting your body in front of the ball, not catching it. Drop to knees, drive chest forward, tuck chin, create a wall. The ball hits your chest protector and stays in front.',
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    description:
      'Pop time = receive + exchange + throw. Elite catchers are under 1.8 seconds. Focus on catching in throwing position, quick exchange, and powerful throw from crouch.',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    description:
      'Quick footwork is essential for throw-downs. Practice the jab step with right foot, clearing hips, and driving toward second base. Feet must work before arm.',
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      'The one-knee stance improves low pitch framing and reduces strain. Right knee down, left foot forward. Glove presented as relaxed target.',
...
const INFIELD_DRILLS: DrillSeed[] = [
  {
    ...
    difficulty: 'Intermediate',
    description:
      "Quick lateral movement is essential. Practice reading the ball off the bat and taking proper angle. Backhand requires glove-side drop step, forehand requires crossing over. React, don't guess.",
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    description:
      'The feed is more important than the arm strength. Shortstop: underhand or backhand feed chest-high. Second base: flip or sidearm. Practice quick exchange and accurate chest-high tosses.',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    description:
      'Short hops require soft hands and staying low. Get your glove out front, let the ball come up into the glove. Practice catching short hops at various speeds. Stay down through the ball.',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    description:
      'Slow rollers require aggressive charge with proper footwork. Approach at angle, field outside right foot, crow hop and throw. Barehand only when absolutely necessary.',
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      "The ready position sets up everything. Feet shoulder-width, weight on balls of feet, glove out front, eyes on pitcher's release. First step is a read step - react to the ball.",
...
const OUTFIELD_DRILLS: DrillSeed[] = [
  {
    ...
    difficulty: 'Intermediate',
    description:
      "The drop step is the outfielder's first move on fly balls. Open hips to the ball side, push off opposite foot, run on an angle. Never backpedal - turn and run. Practice reacting to verbal or visual cues.",
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    description:
      'The crow hop transfers ground force into the throw. Push off back leg explosively, hop and land on back leg, then drive forward into throw. This adds 5-10 mph to outfield throws.',
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      'Track the ball from the bat to glove. Call early, call loud, call often. Center fielder has priority. Practice reading ball off bat and taking direct routes, not arcs.',
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    description:
      'Covering the gaps requires reading the ball immediately and taking efficient angles. Practice going gap-to-gap with full extension catches. Work on diving technique safely.',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    description:
      'Know where the fence is at all times. Practice tracking balls to the warning track, feeling the dirt/grass change, and making catches at the wall safely.',
...
const CONDITIONING_DRILLS: DrillSeed[] = [
  {
    ...
    difficulty: 'Intermediate',
    description:
      'Explosive lower body power for hitting and throwing. Start with 12-18 inch box, progress higher. Focus on full hip extension and soft landing. 3 sets of 8-10 reps.',
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      'Quick feet are essential for all positions. Practice in-in-out-out, lateral shuffles, and crossover patterns. Focus on light, quick touches - not speed at first, then build up.',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    description:
      'Core rotation power for hitting and throwing. Stand perpendicular to wall, rotate hips explosively, throw med ball into wall. This builds the rotational power chain. 3 sets of 10 each side.',
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    description:
      'Full-body explosive conditioning. Burpee into broad jump for distance. This builds total body power and cardiovascular endurance. Great for game-readiness. 3 sets of 6-8 reps.',
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      "Lateral movement is critical for infielders and catchers. Set cones 10-15 feet apart. Shuffle, touch cone, shuffle back. Stay low, don't cross feet. Time yourself for improvement.",
...
const MENTAL_DRILLS: DrillSeed[] = [
  // GENERAL MENTAL
  {
    ...
    difficulty: 'Beginner',
    description:
      '5-10 minutes before games, close eyes and visualize success. See yourself making great plays, getting hits, striking out batters. Engage all senses - feel the ball, hear the crowd. This primes your nervous system for performance.',
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      'When stress hits, use 4-7-8 breathing: Inhale 4 seconds, hold 7 seconds, exhale 8 seconds. This activates the parasympathetic nervous system and calms the body. Use between pitches, at-bats, or after errors.',
  ...
  // PITCHER-SPECIFIC MENTAL
  {
    ...
    difficulty: 'Intermediate',
    description:
      "At 0-2, YOU are in control. This is where elite pitchers finish batters. The mental script: 'I earned this. One more strike. Expand the zone.' Visualize the out before you throw. Attack with your best pitch - don't nibble.",
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    description:
      "The last pitch is GONE. Whether it was a bomb or a strikeout, it doesn't exist anymore. Physical ritual: wipe the rubber with your foot, take a breath, focus on catcher's mitt. Each pitch is independent. Stay present.",
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    description:
      "Channel Kobe's obsessive focus. Before the game, decide: 'I will be the hardest worker on this field today. I will out-compete everyone.' Block out everything except the task at hand. No fear, no excuses, only relentless effort.",
...
const MENTAL_EDGE_CONTENT: MentalEdgeSeed[] = [
  ...
  },
  {
    ...
    source: 'Kobe Bryant',
    content:
      "Rest at the end, not in the middle. You give everything you have for the duration of the task. That's Mamba Mentality.",
  ...
  },
  {
    ...
    source: 'Kobe Bryant',
    content:
      "I don't want to be the next Michael Jordan, I only want to be Kobe Bryant. Your obsession with being the best version of YOU is not weird - it's necessary.",
  ...
  },
  {
    ...
    source: 'Kobe Bryant',
    content:
      "I studied every great player - not to copy them, but to steal something useful from each one. Magic's vision. Jordan's footwork. Hakeem's post moves. Be a student of the game.",
  ...
  // Visualization and Focus
  {
    ...
    content:
      "Elite athletes visualize success 10-15 minutes before competition. Close your eyes. See the pitch coming. Feel your swing. Hear the crack of the bat. Smell the dirt. The brain doesn't fully distinguish between vivid visualization and reality.",
  ...
  },
  {
    ...
    content:
      "Errors happen. Strikeouts happen. What separates good from great is the ability to flush it. The only pitch that matters is the NEXT one. Physical reset: touch the dirt, take a breath, lock eyes on target. Mental reset: 'That's done. What's next?'",
  ...
  // Motivational
  {
    ...
    content:
      "Hard work beats talent when talent doesn't work hard. Your opponent might be more talented, but they can't outwork you unless you let them.",
  ...
  },
  {
    ...
    content:
      "Pressure is a privilege. It means you're in a position to make an impact. Embrace it. Champions don't shrink from big moments - they grow into them.",
  ...
  },
  {
    ...
    content:
      'Fear is an illusion. The only thing real is this moment. Use your fear as fuel. Feel the butterflies? Good. That means you care. Now go compete.',
  ...
  },
  {
    ...
    content:
      "Don't think about the scoreboard. Don't think about the championship. Think about THIS pitch. THIS at-bat. THIS play. Win the moment. Stack enough moments and you'll win the game.",
