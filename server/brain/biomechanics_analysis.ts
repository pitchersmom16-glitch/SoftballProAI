    ...
    components: [
      {
        ...
        subPhases: ['Catch to exchange: 0.15-0.25s', 'Footwork and throw: 0.45-0.65s'],
      },
      {
...
`,
  ...
  exampleAnalysis: {
    ...
    explanation:
      'Your hips and shoulders are rotating together instead of your hips leading first. Think of it like wringing out a towel - you need that twist to create power!',
    impact:
      "This is reducing your velocity by about 5-8 mph. You're relying too much on your arm instead of using your whole body.",
    correction:
      'Focus on: 1) Hip drive drills where your hips fire FIRST, 2) Separation wall drills, 3) Video feedback to feel the difference',
    encouragement:
      "The good news? Your arm mechanics are solid! Once we add hip-shoulder separation, you'll see a big velocity jump.",
    safety:
      'This also protects your shoulder - using your whole body means less stress on your arm.',
  },
};
