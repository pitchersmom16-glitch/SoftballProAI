# ✅ CrossFit Drills for Softball Mechanics - ADDED!

## What Was Just Added to Your Brain

I've added **comprehensive CrossFit drills that directly build softball mechanics** to `strength_training_knowledge.ts`. Here's what's now included:
...
1. **Medicine Ball Rotational Slams** (4x8 each side)
   ...
   - Result: 3-7 mph velocity gain in 8-12 weeks

2. **Kettlebell Swings** (3-4x15-20)
   - Builds: Hip drive and posterior chain explosion
   - Why: Research shows 9.8% max strength + 19.8% explosive power in 6 weeks
   - Result: Stronger leg drive = more velocity

3. **Landmine Rotations** (3x12 each side)
   - Builds: Controlled rotational power
   - Why: Mimics pitching rotation with resistance
   - Maintains spine angle just like pitching

4. **Single-Leg RDLs** (3x10 each)
   - Builds: Drive leg balance and strength
   - Why: Strengthens exact muscles used in stride/drive phase

5. **Pallof Press** (3x15 each side)
   - Builds: Anti-rotation core strength
   - Why: Creates the "separation" that generates velocity
...
1. **Medicine Ball Side Tosses** (4x10 each side)
   ...
   - Result: 5-10 mph exit velocity gain in 12 weeks

2. **Figure-8 Medicine Ball Shotput** (3x8 each)
   - Creates stretch-shortening cycle in swing
   - Teaches hip rotation with upper body lag

3. **Cable Chops** (3x10 each side)
   - Teaches proper swing plane with rotation
   - Downward bat path (attack angle)

4. **Box Jumps / Broad Jumps** (3x5-8)
   - Explosive hip drive for bat speed
   - Triple extension = driving through ball

5. **Glute Bridges & Hip Thrusts** (3x12-15)
   - Back hip drive that initiates rotation
   - Powers the back side rotation in swing
...
- **Release at end** (follow through)

This IS the swing - just with a medicine ball instead of a bat!
...
- ✅ Scale for age and experience
- ❌ NO WOD day before pitching or tournament
- ❌ STOP if pain (not soreness)
...
- ✅ **Exact mechanical transfer** explained (why each movement works)
- ✅ **Age-appropriate scaling** (10U to 18U+)
- ✅ **Programming guidelines** (off-season, in-season, recovery)
