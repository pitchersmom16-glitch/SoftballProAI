...
export const NFHS_RULES = {
  ...
  majorRuleChanges2026: {
    pitchingDelivery: {
      newRule:
        'Beginning in 2026, pitchers may disengage both feet from playing surface if pivot foot is not replanted prior to delivery',
      previous: 'Pivot foot had to remain in contact with ground',
      impact:
        'More flexibility in pitching styles, but no crow hopping (replanting is still illegal)',
    },
    ...
    pitcherDryingAgents: {
      ...
      allowed:
        'Powdered rosin or comparable agents listed on USA Softball certified equipment website',
    ...
    rule8Reformatting: {
      change:
        'Rule 8 reorganized for clarity with separated articles and outlined exceptions/penalties',
  ...
  pointsOfEmphasis2026: {
    obstruction: {
      definition:
        "Requires actual impediment to runner progress - mere positioning doesn't constitute obstruction",
      standard: 'Must show delay, path alteration, or hesitation',
      teaching:
        'Coaches and umpires must understand difference between being in way vs. actual obstruction',
...
export const GSA_RULES = {
  overview: {
    organization:
      'Global Sports Alliance (note: primarily baseball-focused, limited softball info available)',
  ...
  ageEligibility: {
    ...
    documentation:
      'Coaches must provide grade exemption documentation to GSA before player competes',
  },
...
export const RULES_EDUCATION = {
  ...
  commonMisunderstandings: {
    obstructionVsInterference:
      'Obstruction is defense on offense, interference is offense on defense',
    lookBackRule: 'Runner must immediately proceed or return when pitcher has ball in circle',
    infieldFlyRule:
      'Rarely used in softball (less than two outs, runners on first and second or bases loaded)',
